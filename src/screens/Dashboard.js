      ...
      return (
            <div className="  bg-purple-900 flex-1 pb-10 flex">
                  {newContactModal && (
                        <Overlay>
                              ...
                              <div
                                    ...
                                    className="flex flex-row justify-between  max-w-[300px] w-[80%] p-3 bg-gray-800 bg-opacity-75 rounded-lg  text-white"
                              >
                  ...
                  <div className="flex flex-col grow container mx-auto">
                        <div className="flex flex-row justify-between items-center text-white px-3 pt-3">
                        ...
                        <div className=" flex grow flex-row p-2 pb-6  overflow-auto ">
                         ...
                         ${toUser != "" ? "hidden" : "w-full"}`}
                              >
                                    ...
                                    <div onClick={() => setNewContactModal(true)} className="static p-1.5 m-3 bg-teal-600 self-end rounded-full">
